...
//            var result = await this.service.AthleteHasApprovedMembershipByIdAsync(1);
...
//            var result = await this.service.AthleteHasMembershipByIdAsync(1);
//            result.Should().BeTrue();
//        }
...
//            var result = await this.service.GetEditModelByIdAsync(24121);
//            result.Should().BeNull();
//        }
