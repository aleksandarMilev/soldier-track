namespace SoldierTrack.Services.FoodDiary.MapProfile
{
    ...
    public class FoodDiaryProfile: Profile
    {
        ...
        {
            this
                .CreateMap<Food, FoodDiary>();

            this
                .CreateMap<FoodDiary, FoodDiaryServiceModel>();

            this
                .CreateMap<FoodDiary, FoodDiaryDetailsServiceModel>()
                .ForMember(dest => dest.Meals, opt => opt.MapFrom(src => src.Meals));

            this
                .CreateMap<Meal, MealServiceModel>()
                .ForMember(dest => dest.MealsFoods, opt => opt.MapFrom(src => src.MealsFoods));

            this
                .CreateMap<Food, FoodDetailsServiceModel>();

            this
                .CreateMap<MealFood, FoodDetailsServiceModel>()
